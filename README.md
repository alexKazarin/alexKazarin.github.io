...
```shell
git clone https://github.com/alexKazarin/website
```
...
4) Build a local version of your site by executing `hugo server` at the root of the repository. You can see the site by navigating to `http://localhost:1313/website/` (actual URL will be outputted in the CLI) in a browser.
